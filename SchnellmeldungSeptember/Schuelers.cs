...
namespace SchnellmeldungSeptember
{
    ...
    {
        public Schuelers(string connectionStringAtlantis)
        {
...
ORDER BY ausgetreten DESC, klasse, schueler.name_1, schueler.name_2", connection);
                ...
                foreach (DataRow theRow in dataSet.Tables["DBA.schueler"].Rows)
                {
                    ...
                    schueler.IdAtlantis = theRow["AtlantisSchuelerId"] == null ? -99 : Convert.ToInt32(theRow["AtlantisSchuelerId"]);
                    ...
                    schueler.Gliederung = theRow["Gliederung"] == null ? "" : theRow["Gliederung"].ToString();
                    ...
                    schueler.Fachklasse = theRow["Fachklasse"] == null ? "" : theRow["Fachklasse"].ToString();
                ...
                Console.WriteLine(".".PadRight(this.Count / 100, '.') + " " + (this.Count - 1));
            }
        }
    }
}
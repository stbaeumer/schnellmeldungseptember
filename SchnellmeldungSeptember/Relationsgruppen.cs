...
namespace SchnellmeldungSeptember
{
    public class Relationsgruppen : List<Relationsgruppe>
    {
        ...
        {
            Console.WriteLine("Relationsgruppe .. ");
            ...
            this.Add(new Relationsgruppe("BK BF ber. Kennt. und FHS 2-jährig", new List<string>() { "C03" }, new List<string>() { "01", "02" }, null));
            ...
            Console.WriteLine("Relationengruppe " + ".".PadRight(30, '.') + " " + (this.Count - 1));
        }        
    }
}